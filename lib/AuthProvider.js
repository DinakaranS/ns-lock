...
function (_React$Component) {
  ...
  function AuthProvider(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "setSession", function (authResult, profile) {
      var session = {
    ...
    _defineProperty(_assertThisInitialized(_this), "storeSession", function (session) {
      var storageKey = _this.props.storageKey;
      sessionStorage.setItem(storageKey, JSON.stringify(session));
    });

    _defineProperty(_assertThisInitialized(_this), "getStoredSession", function () {
      var storageKey = _this.props.storageKey;
      var session = sessionStorage.getItem(storageKey);
      return session ? JSON.parse(session) : null;
    });

    _defineProperty(_assertThisInitialized(_this), "isSessionExpired", function (expiresAt) {
      return new Date().getTime() > expiresAt;
    });

    _defineProperty(_assertThisInitialized(_this), "rehyrate", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "lockhide", function () {
      _this.lock.hide();
    });

    _defineProperty(_assertThisInitialized(_this), "logout", function (returnTo) {
      var storageKey = _this.props.storageKey;
    ...
    _defineProperty(_assertThisInitialized(_this), "scheduleRenewal", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "renewToken", function () {
